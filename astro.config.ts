...
import {
  ...
  calloutsRehypePlugin,
  checklistRehypePlugin,
  linkifyRehypePlugin,
  labelLeadsRehypePlugin,
  highlightStatsRehypePlugin,
...
export default defineConfig({
  ...
  // Русский — язык по умолчанию (без префикса в URL, как и раньше).
  // Узбекская (кириллица) версия живёт под /uz/...
  i18n: {
    locales: ['ru', 'uz'],
    defaultLocale: 'ru',
    routing: {
